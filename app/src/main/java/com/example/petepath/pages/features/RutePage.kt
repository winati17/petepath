...
//    // Menggunakan ViewModel palsu untuk preview
//    val fakeViewModel = remember {
//        UserViewModel(
//            repository = UserPreferencesRepository(context = LocalContext.current)
//        ).apply {
//            // Mengatur pengguna saat ini untuk preview
//            _currentUserEmail.value = "test@example.com"
//            // Menambahkan pengguna palsu
